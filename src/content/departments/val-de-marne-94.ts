...
export const valDeMarne94: DepartmentContent = {
  ...
  meta: {
    title:
      "Ferrailleur Val-de-Marne (94) — Rachat Métaux & Bennes Chantier | VALMETAUX",
    description:
      "Ferrailleur en Val-de-Marne (94) : rachat cuivre, ferraille de chantier, dépose de bennes. VALMETAUX intervient dans le 94 depuis Argenteuil, virement instantané.",
  },
  hero: {
    headline: "Rachat de Métaux et Ferrailleur dans le Val-de-Marne (94)",
    subheadline:
      "Zones artisanales et chantiers urbains denses du 94 : VALMETAUX valorise vos métaux et évacue vos ferrailles sur site.",
  },
  paragraphs: {
    intro:
      "Artisan, chef de chantier ou gestionnaire de site dans le Val-de-Marne ? **VALMETAUX** intervient dans tout le 94 pour le rachat de métaux, la dépose de bennes et l'évacuation de ferrailles sur site. Règlement par virement instantané dès la pesée.",
    profilZone:
    ...
    interDept:
      "Nos interventions couvrent également la [Seine-Saint-Denis (93)](/ferrailleur-seine-saint-denis-93/) et la [Seine-et-Marne (77)](/ferrailleur-seine-et-marne-77/) pour vos chantiers multi-sites. Retrouvez notre [centre de récupération à Argenteuil](/).",
  },
  internalLinks: {
