...
// Essonne — pôle scientifique et industriel (Saclay, Évry, Corbeil).
// Ateliers d'usinage, industries high-tech, chantiers urbains denses.
// Angle : B2B prioritaire, métaux spéciaux, enlèvement volumes.
export const essonne91: DepartmentContent = {
  slug: "ferrailleur-essonne-91",
  nom: "Essonne",
  code: "91",
  meta: {
    title:
